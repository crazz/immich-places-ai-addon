...
Read and follow the project working agreements in [AGENTS.md](AGENTS.md), including its required engineering documents, before OpenSpec planning, implementation or review. AGENTS.md is the shared instruction entry point; do not maintain a separate copy of the standards here.
