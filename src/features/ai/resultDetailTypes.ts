...
export type TStoredProposal = Record<'schema_version', '1.0'> & {
...
export function isResultDetail(value: unknown): value is TResultDetail {
	...
	return isRecord(proposal) && proposal.schema_version === '1.0' && proposal.outcome === value.entry.proposalOutcome &&
