...
| [CH18 `preview-exact-ai-write-plans`](../../openspec/changes/preview-exact-ai-write-plans/proposal.md) | Prepared, not implemented: fresh authorized before-values and an immutable five-minute, revision-bound, single-target GPS preview with a digest. No mutation executor. | CH16 |
