...
| [CH16 `persist-revisioned-ai-review-drafts`](../../openspec/changes/persist-revisioned-ai-review-drafts/proposal.md) | Implemented and synchronized, active without archive: durable accept/edit/stage/reject, numeric/map editing, exact GPS scope, explicit baseline review, concurrent-edit detection and stale-content invalidation. Accept performs zero writes; AI drafts cannot enter the manual save path. See [executed verification](../../openspec/changes/persist-revisioned-ai-review-drafts/implementation-verification.md). | CH15 |
| [CH17 `retranslate-reviewed-ai-descriptions`](../../openspec/changes/retranslate-reviewed-ai-descriptions/proposal.md) | Implemented and verified: [text-only generation, retained outcomes and revision-checked adoption](../ai-description-translations.md). Seven requirements synchronized; change remains unarchived. | CH09, CH16 |
| [CH18 `preview-exact-ai-write-plans`](../../openspec/changes/preview-exact-ai-write-plans/proposal.md) | Implemented and synchronized, active without archive: fresh authorized before-values and an immutable five-minute, revision-bound, single-target GPS preview with a digest. No mutation executor. See [executed verification](../../openspec/changes/preview-exact-ai-write-plans/implementation-verification.md). | CH16 |
| [CH19 `execute-confirmed-ai-gps-writes`](../../openspec/changes/archive/2026-09-25-execute-confirmed-ai-gps-writes/proposal.md) | Implemented, verified, synchronized and archived: first approved single-asset GPS mutation with durable audit, fresh conflict checks, exact targets, serialized overlap, no hidden retries and verified recovery/refresh. See [CH19 verification](../../openspec/changes/archive/2026-09-25-execute-confirmed-ai-gps-writes/implementation-verification.md). Ordinary dispatch remains disabled; live rollout requires GATE-02. | CH18, CH11 |
| [CH20 `write-approved-ai-descriptions`](../../openspec/changes/write-approved-ai-descriptions/proposal.md) | Implemented and verified: [independent description selection, exact replace/managed append and per-field recovery](../ai-description-writes.md). Six requirements added and twelve updated across two synchronized capabilities; change remains unarchived. | CH19 |
| [CH21 `confirm-explicit-ai-stack-targets`](../../openspec/changes/confirm-explicit-ai-stack-targets/proposal.md) | Implemented and verified: [exact stack GPS selection and independent target outcomes](../ai-stack-writes.md). Six requirements added and twelve updated across two synchronized capabilities; retained v1/v2 approvals stay unchanged. Change remains unarchived; live stack compatibility remains separate. | CH19 |
| [CH22 `mirror-supported-ai-metadata`](../../openspec/changes/mirror-supported-ai-metadata/proposal.md) | Implemented, verified and synchronized: [optional reviewed metadata](../ai-metadata-mirroring.md) uses an independently reserved analyzed-photo namespace step, private lineage and metadata-only recovery. Standard success and local records remain intact. Live metadata compatibility remains separately gated. | CH20 |
...
After implementation and verification, reconcile/sync the change's deltas before advancing conflicting successors. Archive completed changes when authorized; the CH16 → CH18 → CH19 batch explicitly remains active without archive and commits each verified, synchronized predecessor before starting its successor. Keep normative requirements in one main capability spec; several small changes can evolve it. Preserve existing OpenSpec/Plus configuration and its adopted engineering/reference-document context. Allocate migration numbers from the actual implementation checkout, not from this roadmap.
