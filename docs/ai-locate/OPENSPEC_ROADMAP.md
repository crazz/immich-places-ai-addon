...
| [CH12 `connect-visual-analysis-to-durable-jobs`](../../openspec/changes/connect-visual-analysis-to-durable-jobs/proposal.md) | Planned: Execute Visual analysis from frozen selections through CH11, binding consent/profile revision and enforcing access checks, enablement, deadlines, call/token limits and bounded transport behavior. Add submission/cancellation access for the usable workflow. | CH09, CH11 |
