...
| CH11 `add-recoverable-ai-job-execution` | Durable job/item states, immutable terminal results, leases/fencing, cancellation, restart recovery, bounded attempts and idempotent submission. Verify the lifecycle with a deterministic fake provider before production dispatch. Reuse CH05's implemented minimal installation identity, extending controlled reindex/invalidation and defining job/result cleanup without a competing instance key. | CH01, CH05, CH07 |
