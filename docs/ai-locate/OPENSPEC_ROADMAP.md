...
| [CH19 `execute-confirmed-ai-gps-writes`](../../openspec/changes/execute-confirmed-ai-gps-writes/proposal.md) | Implemented, verified and synchronized: first approved single-asset GPS mutation with durable audit, fresh conflict checks, exact targets, serialized overlap, no hidden retries and verified recovery/refresh. See [CH19 verification](../../openspec/changes/execute-confirmed-ai-gps-writes/implementation-verification.md). Ordinary dispatch remains disabled; live rollout requires GATE-02. | CH18, CH11 |
