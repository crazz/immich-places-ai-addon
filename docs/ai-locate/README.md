...
- [CH16 → CH18 → CH19 batch](CH16_CH18_CH19_PLAN.md): CH16 implements local review drafts; CH18 adds [exact read-only GPS previews](../ai-write-previews.md). Both maintained capabilities are synchronized. Their [draft](../../openspec/changes/persist-revisioned-ai-review-drafts/implementation-verification.md) and [preview](../../openspec/changes/preview-exact-ai-write-plans/implementation-verification.md) records report executed checks. CH19 now implements [confirmed single-photo GPS writes](../ai-gps-writes.md), with both deltas synchronized, CH19 archived and [verification recorded](../../openspec/changes/archive/2026-09-25-execute-confirmed-ai-gps-writes/implementation-verification.md). Ordinary dispatch remains disabled pending live GATE-02; codex-proxy work is deferred.
- [CH17 → CH20 → CH21 → CH22 planning batch](CH17_CH20_CH22_PLAN.md): prepared proposals, designs, capability deltas, tasks and verification plans for reviewed translation regeneration, description writing, explicit stack GPS targets and optional metadata mirroring. CH17, CH20, CH21 and CH22 are implemented, verified and synchronized. CH19 live verification remains separate.
...
CH10 and CH12–CH15 are now implemented and archived. [The batch record](CH10_CH12_CH15_PLAN.md) records their dependency order and verification. CH12 supersedes the earlier internal-only Visual/job limits; CH13 also connects consented Context-assisted work. CH14 retains private history independently of source availability, and CH15 provides isolated read-only inspection. CH16 adds [durable local draft editing](../ai-review-drafts.md) and CH18 adds [exact read-only previews](../ai-write-previews.md); CH19 adds [confirmed GPS writing](../ai-gps-writes.md), disabled by default pending live GATE-02; CH17 adds [reviewed text translation and explicit adoption](../ai-description-translations.md). CH20 adds [independent description writes and per-field recovery](../ai-description-writes.md), with separate default-off capability admission. CH21 adds [explicit stack GPS targets and independent recovery](../ai-stack-writes.md), preserving older approvals and manual edits. CH22 adds [optional reviewed metadata mirroring](../ai-metadata-mirroring.md), with an independent namespace step and standard-success preservation.
