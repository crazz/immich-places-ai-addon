...
- [CH16 → CH18 → CH19 batch](CH16_CH18_CH19_PLAN.md): CH16 implements local review drafts and is synchronized into the maintained capability. Its [verification record](../../openspec/changes/persist-revisioned-ai-review-drafts/implementation-verification.md) reports executed checks. Exact GPS previews (CH18) and confirmed single-photo writes (CH19) remain prepared; codex-proxy work is deferred.
