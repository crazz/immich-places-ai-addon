...
Take a consistent SQLite backup before deployment. Roll back binaries with additive tables retained; destructive down migrations remove audit and are not recovery. No rollback claims to undo upstream GPS, clear GPS or finish sidecars. No live rollback was performed. See the [CH19 verification record](../openspec/changes/archive/2026-09-25-execute-confirmed-ai-gps-writes/implementation-verification.md) for executed synthetic checks and remaining limits, and the preview deployment record below for subsequent rollout evidence.

The [recovery follow-up verification](../openspec/changes/archive/2026-09-25-execute-confirmed-ai-gps-writes/recovery-verification.md) records late-history, repeat-rejection and durable retry replay regressions.

The [25 September preview deployment](engineering/nas-ch19-preview-2026-09-25.md) records the healthy CH19 runtime and migration 25→28. Writing remains disabled; the live compatibility gate still needs authenticated confirmation and observed mutation/readback evidence.
