...
See [proposal.md](proposal.md), [CH10's context contract](../2026-09-20-add-consented-ai-context/design.md), [CH12's production contract](../2026-09-20-connect-visual-analysis-to-durable-jobs/design.md) and the adopted [architecture](../../../../docs/engineering/architecture.md), [testing](../../../../docs/engineering/testing.md) and [coding standards](../../../../docs/engineering/coding-standards.md). Grounded at `23c6ca6`: GitNexus resolves `PhotoList` through the existing gallery/container/selection flow. Source confirms separate page assets and selected IDs, an existing trailing-action integration point and a validated private provider API. Jobs and selection UI clients do not yet exist. Current completion is Visual-only, so Context cannot be enabled by a frontend mode toggle alone.
