...
See [proposal.md](proposal.md), [CH14 detail](../browse-persistent-ai-results/design.md), the [canonical schema](../../../backend/internal/ai/results/ai-analysis-result.v1.schema.json), and adopted [architecture](../../../docs/engineering/architecture.md), [testing](../../../docs/engineering/testing.md) and [coding standards](../../../docs/engineering/coding-standards.md). At `23c6ca6`, GitNexus traces map interaction into pending-selection and group-move handlers. Source confirms that the ordinary `MapView` installs click/drop/reset actions and `LocationConfirm`; putting AI markers into that composition without isolating those actions would grant unintended manual-edit behavior. Canonical proposals already distinguish candidate camera, subject, direction, evidence references and per-language status.
