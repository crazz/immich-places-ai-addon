...
Depends on CH06 and the planned [CH10](../archive/2026-09-20-add-consented-ai-context/proposal.md) and [CH12](../connect-visual-analysis-to-durable-jobs/proposal.md). Apply and sync those changes first. Affects `src/features/ai/`, narrow gallery integration, jobs admission/execution and additive provenance storage. Uses existing frontend, map, HTTP and Go dependencies.
