...
Prerequisite: [CH05](../freeze-explicit-ai-selections/proposal.md). Covers FR-01–02, NFR-01–05/NFR-07–08 as applicable to selection, and AC-01/AC-09 from the [PRD](../../../docs/ai-locate/PRD.md). Performance evidence here is a bounded resolver measurement; submission and end-to-end gallery latency acceptance remain with their roadmap owners. No departure from the adopted engineering standards is proposed.
